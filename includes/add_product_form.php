    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow">
            ...
            <div class="modal-header border-0 bg-light rounded-top-4 px-4 pt-4">
                <h5 class="modal-title font-heading fw-bold text-dark-blue" id="productModalLabel">Product Details</h5>
            ...
            <form id="mainProductForm" method="POST" action="" enctype="multipart/form-data">
                <div class="modal-body px-4 pb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="brand_name" class="form-label small fw-bold text-secondary">Brand Name</label>
                            <input type="text" class="form-control rounded-3" id="brand_name" name="brand_name" required>
                        </div>
                        <div class="col-md-6">
                            <label for="generic_name" class="form-label small fw-bold text-secondary">Generic Name</label>
                            <input type="text" class="form-control rounded-3" id="generic_name" name="generic_name">
                        </div>

                        <div class="col-md-6">
                            <label for="category_id" class="form-label small fw-bold text-secondary">Category</label>
                        ...
                        <div class="col-md-6">
                            <label for="size_volume" class="form-label small fw-bold text-secondary">Size / Volume</label>
                            <input type="text" class="form-control rounded-3" id="size_volume" name="size_volume">
                        </div>

                        <div class="col-md-4">
                            <label for="unit_price" class="form-label small fw-bold text-secondary">Unit Price (₱)</label>
                            <input type="number" step="0.01" class="form-control rounded-3" id="unit_price" name="unit_price" required>
                        </div>
                        <div class="col-md-4">
                            <label for="stock_quantity" class="form-label small fw-bold text-secondary">Stock Quantity</label>
                            <input type="number" class="form-control rounded-3" id="stock_quantity" name="stock_quantity" required>
                        </div>
                        <div class="col-md-4">
                            <label for="reorder_level" class="form-label small fw-bold text-secondary">Reorder Level</label>
                        ...
                        <div class="col-12">
                            <label for="picture_link" class="form-label small fw-bold text-secondary">Or Image URL Link (Optional)</label>
                            <input type="text" class="form-control rounded-3" id="picture_link" name="picture_link" placeholder="https://example.com/image.jpg">
                        </div>

                        <div class="col-12">
                            <label for="other_details" class="form-label small fw-bold text-secondary">Other Details</label>
